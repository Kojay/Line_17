    ...
    [
        ...
        'content'=>
            GridView::widget([
                ...
                'export' => false,
                'rowOptions' => function ($model, $index, $widget, $grid) {
                    return ['_rqstIDUserID' => $model['userID'], 'onclick' => 'location.href="'.Url::to(['user/user']).'&_rqstIDUserID="+(this._rqstIDUserID);','style' => 'cursor: pointer'];
                },
                'columns' => [
                    ['class' => '\kartik\grid\SerialColumn'],
                    [
    ...
    [
        ...
        'content'=>
            GridView::widget([
                ...
                'export' => false,
                'rowOptions' => function ($model, $index, $widget, $grid) {
                    return ['_rqstIDfhnwNumber' => $model['fhnwNumber'], 'onclick' => 'location.href="'.Url::to(['article/article']).'&_rqstIDfhnwNumber="+(this._rqstIDfhnwNumber);','style' => 'cursor: pointer'];
                },
                'columns' => [
                    ['class' => '\kartik\grid\SerialColumn'],
                    [
    ...
    [
        ...
        'content'=>
            GridView::widget([
                ...
                'export' => false,
                'rowOptions' => function ($model, $index, $widget, $grid) {
                    return ['fhnwNumber' => $model['fhnwNumber'], 'onclick' => 'location.href="'.Url::to(['article/article']).'&_rqstIDfhnwNumber="+(this.fhnwNumber);','style' => 'cursor: pointer'];
                },
                'columns' => [
                    ['class' => '\kartik\grid\SerialColumn'],
                    [
