...
echo Html::a('<i class="glyphicon glyphicon-arrow-left"></i> Zurück', ['artikel/artikelliste'],['class' => 'btn btn-primary pull-left']);
?>
...
<div class="panel panel-info" style="margin-top: 10px">
    ...
    <div class="panel-body">
        ...
        <div id="breadcrumbs">
            <a style="margin-left:20px"  href="<?= Url::toRoute('artikel/neuerartikel')?>"><span class="glyphicon glyphicon-arrow-right"></span> Artikel erstellen</a>
        </div>
    </div>
</div>